...
public class SalespersonDataLoader implements CommandLineRunner{
	...
	private void loadSalespersonData() throws ParseException {
		...
		if (salespersonRepository.count() == 0) {
			...
			Salesperson s2 = new Salesperson(2,"Jim","Helpert","124 maple ave","(123)349-9876",1, sdf.parse("2013-05-31 20:00:00"),sdf.parse("2023-05-31 20:00:00"));
			Salesperson s3 = new Salesperson(3,"Michale","Scott","126 maple ave","(123)345-9879",1, sdf.parse("2011-05-31 20:00:00"),sdf.parse("2023-05-31 20:00:00"));
